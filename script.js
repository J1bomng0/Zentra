const termList = [
    ...
    "ადასტურებთ რომ ხართ სრულწლოვანი, არასრულწოლოვანები შემთვევაში გაქვთ მშობლის თანხმობა",
    "ყველა კონტენტი ეკუთვნის აპლიკაციას ან მის ლიცენზიანტებს და დაცულია საავტორო უფლებების კანონით.",
    "არ გაქვთ უფლება ჩაერთოთ საქმიანობაში, რომელიც აზიანებს აპლიკაციას ან არღვევს კანონს.",
    "თანხმა ვარ, დაამუშავოტ და გაყიდოთ ჩემი მონაცემები საჭიროებისამებრ და ისე, როგორც შემქმნელებს მოესურვებათ",
